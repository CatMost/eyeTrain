...
@implementation SmoothedBIView2
{
    UIBezierPath *path;
...
- (void)initCommon
{
    ...
    answerImage = [UIImage imageNamed:@"answer2.png"];
    modelImage = [UIImage imageNamed:@"model.png"];
    guideImage = [UIImage imageNamed:@"guide2.png"];
    
    gradeAImage = [UIImage imageNamed:@"grade_a.png"];
    gradeBImage = [UIImage imageNamed:@"grade_b.png"];
    gradeCImage = [UIImage imageNamed:@"grade_c_minus.png"];
    gradeDImage = [UIImage imageNamed:@"grade_d.png"];
    gradeFImage = [UIImage imageNamed:@"grade_f.png"];
    ...
    // guide image view
    guideImageView = [[UIImageView alloc] initWithFrame:CGRectMake(80, 62, 133, 246)];
...
- (void)showAnswer
{
    ...
    answerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(342, 375, 328, 547)];
    answerImageView.image = guideImage;
    answerImageView.alpha = 0.5;
...
- (int)calculateScore
{
    int drawResult = [self analysePixels:incrementalImage] * 2.0;
